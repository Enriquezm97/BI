# Generated by Django 3.2.15 on 2023-01-27 11:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name_rubro', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.AddField(
            model_name='empresa',
            name='rubro_empresa',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.rubro'),
        ),
    ]
