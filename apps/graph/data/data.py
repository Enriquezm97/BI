...
df_var_agricolas_default=cleanVariablesAgricolas(df_consumidores,
                                                  ...
                                                  df_cultivos,
                                                  df_fertilizacion)
df_var_agricolas_arona=cleanVariablesAgricolas(df_consumidores,
                                                  df_variedad,
                                                  df_cultivos,
                                                  df_fertilizacion)
df_var_agricolas_greenfruits=cleanVariablesAgricolas(df_consumidores,
                                                  df_variedad,
                                                  df_cultivos,
                                                  df_fertilizacion           
                                                   )
...
df_costos_agricola_arona=costosAgricolas(df_costos_campana,df_consumidores,df_cultivos,df_variedad)
df_costos_agricola_greenfruits=costosAgricolas(df_costos_campana,df_consumidores,df_cultivos,df_variedad)
...
df_ventas_detalle_arona=cleanVentas(df_ventas_default)
df_ventas_detalle_greenfruits=cleanVentas(df_ventas_default)
df_ventas_detalle_aerodiana=cleanVentas(df_ventas_default)
...
df_control_contenedores_greenfruits=cleanContenedores(df_control_expo_arona)
df_control_contenedores_arona=cleanContenedores(df_control_expo_arona)
df_control_contenedores_aerodiana=cleanContenedores(df_control_expo_arona)
