...
from apps.graph.test.utils.blocks.block_card import cardGraph,cardSection,cardGraphwithfilter,card_graph_1,card_segment
...
def informeComercial(codigo= '',rubro_empresa = 'Agricola', config_dash = {}):
        ...
        Row([
            Column([
                dmc.Card(children=[
                    dmc.Grid(
                        children =[
                            Column([Div(id='title')],size=12),
                            Column([],size=1),
                            Column([Entry.chipGroup(id='chipgroup-mes')],size=10),
                ...
                Row([
                    ...
                    Column([
                            ...
                            Row([
                                Column([
                                    card_graph_1(
                                        text= 'Grupo Producto mas vendido',
    ...
    Container([Div(id='notifications-update-data'),]),
...
def ventaSegmented(codigo = '',rubro_empresa = 'Agricola', filtros = input_dict_general ):
    ...
    app.layout = Container([
        ...
        block_offcanvas_comercial_filter(dict_filtros = filtros, diccionario_componentes= dict_components_comercial(),add_filter=[
            dmc.Checkbox(id="checkbox-ticked", label="Mostrar Tickeds", mb=10, checked=False,size="md"),
        ...
        Row([
            Column([
                dmc.Card(children=[
                    dmc.Grid(
                        children =[
                            Column([Button.btnFilter(style={'position': 'absolute','z-index': '99'}),],size=1),
                            Column([dmc.Title(children=['Seguimiento de Ventas'],order=2,align='center')],size=10),
                            Column([Column([Button.btnDownload()],size=1),],size=1),
        ...
        Row([
            ...
            Column([
                card_segment(
                    ...
                    id_segmented='segmented-pie',
                    value = 'Vendedor',
                    data = [{'label': 'Vendedor', 'value': 'Vendedor'},{'label': 'País', 'value': 'Pais'},{'label': 'Sucursal', 'value': 'Sucursal'},{'label': 'Mes', 'value': 'Mes'}],
                    height=330
                ),
            ...
            Row([
                Column([
                    card_segment(
                        ...
                        id_segmented='segmented-bar',
                        value = 'Tipo de Venta',
                        data = [{'label': 'Tipo de Venta', 'value': 'Tipo de Venta'},
               ...
               Row([
                    Column([
                        card_segment(
                            ...
                            id_segmented='segmented-bar-categoria',
                            value = 'Producto',
                            data = [{'label': 'Producto', 'value': 'Producto'},
               ...
               Row([
                    Column([
                        card_segment(
                            ...
                            id_segmented='segmented-st',
                            value = 'Mes',
                            data = [{'label': 'Mensual', 'value': 'Mes'},{'label': 'Trimestral', 'value': 'Trimestre'},
                                     {'label': 'Semanal', 'value': 'Semana'},{'label': 'Fecha', 'value': 'Fecha'}],
                            height=360
                        ),
               ...
               Row([
                    Column([
                        card_segment(
                            ...
                            id_segmented='segmented-bar-categoria',
                            value = 'Cliente',
                            data = [{'label': 'Cliente', 'value': 'Cliente'},
                                    {'label': 'Tipo de Venta', 'value': 'Tipo de Venta'},   
                                    {'label': 'Pais', 'value': 'Pais'},
                                    {'label': 'Vendedor', 'value': 'Vendedor'}],
                            height=360
