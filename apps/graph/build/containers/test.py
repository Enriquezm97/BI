    ...
    app.layout = html.Div(
        [
            ...
            dbc.Row(
                [
                    dbc.Col([
                        cardIndex('Gastos Operativos','/gastos-operativos','https://i.imgur.com/ES1oQBT.jpg',"lg")
                    ],width=4,className="col-xl-4 col-md-12 col-sm-12 col-12 mb-3"),
                    dbc.Col([
                        cardIndex('Plan de Siembra','/plan-siembra','https://i.imgur.com/BVQUPW7.jpg',"xl")
                    ],width=4,className="col-xl-4 col-md-12 col-sm-12 col-12 mb-3"),
                    dbc.Col([
                        cardIndex('Variables agricolas','/variables-agricolas','https://i.imgur.com/wExhz7M.jpg',"xs")
                    ],width=4,className="col-xl-4 col-md-12 col-sm-12 col-12 mb-3"),
                ],
            ...
            dbc.Row(
                [
                    dbc.Col([
                        #make_card('Contenedores','/ctrl-contenedores-1','https://i.imgur.com/K4Tb6ND.jpg')
                        cardIndex('Contenedores','/ctrl-contenedores-1','https://i.imgur.com/K4Tb6ND.jpg',"xs")
                    ],width=4,className="col-xl-4 col-md-12 col-sm-12 col-12 mb-3"),
                    dbc.Col([
                        cardIndex('Indicadores','/indicadores','https://i.imgur.com/GnaEryA.jpg',"md")
                        #make_card('Indicadores','/indicadores','https://i.imgur.com/GnaEryA.jpg')
                    ],width=4,className="col-xl-4 col-md-12 col-sm-12 col-12 mb-3"),
                    dbc.Col([
                        cardIndex('Ventas','/ventas-1','https://i.imgur.com/GEa2Zpq.jpg',"sm")
                        #make_card('Ventas','/ventas-1','https://i.imgur.com/GEa2Zpq.jpg')
                    ],width=4,className="col-xl-4 col-md-12 col-sm-12 col-12 mb-3"),
                ],
...
def live_update():
    ...
    app = DjangoDash('live-update', external_stylesheets=[dbc.themes.BOOTSTRAP])

    app.layout = html.Div(
    html.Div([
        html.H4('Live Update Satelite TEST'),
    ...
    def update_graph_live(n):
        ...
        # Collect some data
        for i in range(180):
            time = datetime.now() - datetime.timedelta(seconds=i*20)
