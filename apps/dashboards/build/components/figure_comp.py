...
import pandas as pd
import numpy as np
from ...constans import DIC_RECURSOS_AGRICOLA,COLORS_G10,DICT_CULTIVOS_COLOR,DICT_TIPO_COSTO
from ..utils.helpers import create_stack_np, create_hover_custom
